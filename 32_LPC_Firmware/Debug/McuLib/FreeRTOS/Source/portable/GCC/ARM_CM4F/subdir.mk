...
McuLib/FreeRTOS/Source/portable/GCC/ARM_CM4F/%.o: ../McuLib/FreeRTOS/Source/portable/GCC/ARM_CM4F/%.s McuLib/FreeRTOS/Source/portable/GCC/ARM_CM4F/subdir.mk
	...
	arm-none-eabi-gcc -c -x assembler-with-cpp -D__REDLIB__ -I"C:\Users\andre\Documents\GitHub\32CleanBeaches_Firmware\32_LPC_Firmware\board" -I"C:\Users\andre\Documents\GitHub\32CleanBeaches_Firmware\32_LPC_Firmware\source" -g3 -mcpu=cortex-m0plus -mthumb -D__REDLIB__ -specs=redlib.specs -o "$@" "$<"
	@echo 'Finished building: $<'
	@echo ' '
